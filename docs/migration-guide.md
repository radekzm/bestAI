...
If you have a massive `CLAUDE.md` (e.g., >150 lines), bestAI v6.0 requires you to embrace **Progressive Disclosure**:
...
The biggest change in v6.0 is the **Fail-Closed Hook System** with composition validation.
...
## Step 4: Upgrading to v6.0 Multi-Agent Orchestration (Optional)
...
```
If you see all green `OK` messages, your project is officially running bestAI v6.0!
